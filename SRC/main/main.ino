...
void loop() {
  ...
  pos_map.plot_points(PI, 5);
  pos_map.plot_points(-PI/6, 55);
  pos_map.plot_points(PI/6, 35);
  pos_map.plot_points(PI/3, 32);
  pos_map.plot_points(PI/4, 49);
  pos_map.plot_points(PI/6, 60);
  pos_map.plot_points(-PI/3,10);
  pos_map.plot_points(-PI/4,10);
  pos_map.plot_points(-PI/6,10);
  pos_map.plot_points(-PI/3, 56);
